...
<div class="container">
	<div class="panel panel-info">
		<div class="panel-heading text-center">
			<h3>请假列表 <span style="font-size:10px" class="label label-success">已通过：${lbc}</span>
	...
	<div class="panel-body">
		<div class="table-responsive">
			<table   class="table">
				...
				<tbody>
				<c:forEach items="${LeaveBillList}" var="sk" varStatus="status">
